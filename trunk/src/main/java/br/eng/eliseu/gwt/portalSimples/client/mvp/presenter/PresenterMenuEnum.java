...
public enum PresenterMenuEnum  {
	...
	private PresenterMenuEnum(Integer parentId, Integer id, TipoMenu tipoMenu, LocalDestino local, 
	...
	public static PresenterMenuEnum[] valuesAcesso() {
		PresenterMenuEnum[] values = new PresenterMenuEnum[values().length];
		int i=0;
		for (PresenterMenuEnum item : PresenterMenuEnum.values()) {
